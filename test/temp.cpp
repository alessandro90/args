...
TEST_CASE("Factorials are computed", "[factorial]") {  // NOLINT
    static constexpr auto option = args::Flag{
        .long_form = "option_1"_flag, .short_form = args::Opt<char>::with('j'), .required = true};
    static constexpr auto option_x = args::default_flag_with_value<int>(args::FlagWithValueArgs{
        .long_form = "option_2"_flag, .short_form = args::Opt<char>::with('r')});
